...
import { Plus, Edit, Trash2, Question as QuestionIcon, Eye, EyeOff } from '@phosphor-icons/react'
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingQuestion ? 'Update question information' : 'Add a new practice question'}
              </DialogDescription>
            </DialogHeader>
